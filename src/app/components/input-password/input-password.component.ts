...
import { ComponentConfig, InputPasswordConfig, ElementType, GenericFunction, StyleGroup, WeakObject, PPasswordConfig } from 'warskald-ui/models';
import { initStyleGroups, LoggableComponent, LogLevels } from 'warskald-ui/services';

@LoggableComponent({
    LOCAL_ID: 'InputPasswordComponent',
    autoAddLogs: true,
    canLog: true,
    localLogLevel: LogLevels.Error
})
@Component({
    selector: 'ws-input-password',
    standalone: true,
    imports: [
        PasswordModule,
        CommonModule,
...
export class InputPasswordComponent implements InputPasswordConfig, ControlValueAccessor {

    // #region public properties


    public defaultBaseStyleClass: string = 'app-input-password';
    ...
    @Input() elementType = ElementType.INPUT_PASSWORD as const;
    ...
    @ViewChild('passwordRef') passwordRef?: Password;
